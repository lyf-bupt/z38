...
{
	printf("server6 enter readFileHandleFun ,ready to readFileHandle\n");
	...
	printf("server6 enter readFileHandleFun end ,SetEvent(readFileHandle)\n");
}
...
DWORD WINAPI recvFun(LPVOID lp)
{
	...
	printf("server6 enter recvFun ,ready to recv\n");
