...
{
	printf("server2 enter readFileHandleFun ,ready to readFileHandle\n");
	...
	printf("server2 enter readFileHandleFun end ,SetEvent(readFileHandle)\n");
}
...
DWORD WINAPI recvFun(LPVOID lp)
{
	...
	printf("server2 enter recvFun ,ready to recv\n");
