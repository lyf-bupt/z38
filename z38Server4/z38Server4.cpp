...
{
	printf("server4 enter readFileHandleFun ,ready to readFileHandle\n");
	...
	printf("server4 enter readFileHandleFun end ,SetEvent(readFileHandle)\n");
}
...
DWORD WINAPI recvFun(LPVOID lp)
{
	...
	printf("server4 enter recvFun ,ready to recv\n");
