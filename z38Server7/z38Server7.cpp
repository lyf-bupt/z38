...
{
	printf("server7 enter readFileHandleFun ,ready to readFileHandle\n");
	...
	printf("server7 enter readFileHandleFun end ,SetEvent(readFileHandle)\n");
}
...
DWORD WINAPI recvFun(LPVOID lp)
{
	...
	printf("server7 enter recvFun ,ready to recv\n");
