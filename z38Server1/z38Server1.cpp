...
{
	printf("server1 enter readFileHandleFun ,ready to readFileHandle\n");
	...
	printf("server1 enter readFileHandleFun end ,SetEvent(readFileHandle)\n");
}
...
DWORD WINAPI recvFun(LPVOID lp)
{
	...
	printf("server1 enter recvFun ,ready to recv\n");
