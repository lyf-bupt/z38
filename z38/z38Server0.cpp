...
{
	printf("server0 enter readFileHandleFun ,ready to readFileHandle\n");
		...
		printf("server0 enter readFileHandleFun end ,SetEvent(readFileHandle)\n");
}
...
DWORD WINAPI recvFun(LPVOID lp)
{
	...
	printf("server0 enter recvFun ,ready to recv\n");
...
int main()
{
	...
	while (1)
	{
		...
		printf("when readFileHandleFun goes on ,main thread also goes on\n");
