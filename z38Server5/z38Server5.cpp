...
{
	printf("server5 enter readFileHandleFun ,ready to readFileHandle\n");
	...
	printf("server5 enter readFileHandleFun end ,SetEvent(readFileHandle)\n");
}
...
DWORD WINAPI recvFun(LPVOID lp)
{
	...
	printf("server5 enter recvFun ,ready to recv\n");
